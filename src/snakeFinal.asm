...
print_stuff:
  ...
  mov al, 0x09   ; use 'o' as as food symbol
  ...
  mov al, 0x02   ; use face as snake head symbol
...
snake_body_print_loop:
  ...
  mov al, 0x09   ; use 'o' as the snake body symbol
...
game_loop_continued:
  ...
  mov dx, 0xC350  ; 0x0000C350 = 50000
  ;mov cx, 0x0001  ; Sleep for 0,10 seconds (cx:dx)
  ;mov dx, 0x86A0  ; 0x000186A0 = 100000
